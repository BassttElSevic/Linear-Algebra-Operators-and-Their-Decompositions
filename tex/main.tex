...
\newcommand{\authoronehandle}{github.com/Singularity-baakaka}
\newcommand{\authoronerole}{著}
\newcommand{\authortwo}{阿酒\;\textbullet\;Basstt ElSevic}
\newcommand{\authortwohandle}{github.com/BassttElSevic}
...
\begin{flushleft}
  ...
  \hspace{0.9em}{\small\color{pagegray}\authoronerole}\\[1mm]
  {\small\color{accent!80}\texttt{\authoronehandle}}\\[4.2mm]
  {\sffamily\large\color{mainblue!85!black}\authortwo}%
  \hspace{0.9em}{\small\color{pagegray}\authortworole}\\[1mm]
  {\small\color{accent!80}\texttt{\authortwohandle}}\\[6mm]
...
\textsf{\textbf{\color{inkblue}版本与许可}}\\[4pt]
\bookdate 编译。源码与修订历史由 Git 管理。\\
本书正文、\LaTeX{} 模版与转换脚本采用 \textbf{MIT} 许可：
可自由使用、修改与再分发（含商业用途），保留版权与许可声明即可。\\
\copyright{} 2026 \authorone、\authortwo。
\end{flushleft}
\vspace*{18mm}
